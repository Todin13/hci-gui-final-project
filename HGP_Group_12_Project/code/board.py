from PyQt6.QtWidgets import QFrame, QApplication, QDialog, QVBoxLayout, QLabel, QComboBox, QRadioButton, QButtonGroup, QLineEdit, QHBoxLayout, QPushButton, QMessageBox
...
class Board(QFrame):
    ...
    def __init__(self, parent=None, scoreBoard=None):
        ...
        self.handicap = {"player": "None", "type": None, "value": None, "komi": "6.5"}
...
class HandicapDialog(QDialog):
    ...
    def get_results(self):
        ...
        return {
            ...
            "type": "Points" if self.point_radio.isChecked() else ("Pieces" if self.piece_radio.isChecked() else None),
            "value": self.value_input.currentText() if self.value_input.isEnabled() else None,
